                                                        ...
                                                        <table style="border: 1px solid #E0E0E0; border-radius: 3px;" cellpadding="10" cellspacing="0">
                                                            <tbody style="border: 1px solid #E0E0E0; border-radius: 3px; margin: 10px 0; padding: 10px;">
                                                                ...
                                                                if (!empty($shippingAmount)) {
                                                                    ...
                                                                    ?>
                                                                    <tr class="sub_total">
                                                                        <td style="padding: 5px 10px; border-bottom: 1px #E0E0E0 solid; border-right: 1px #E0E0E0 solid; text-align: right" align="right" colspan="2"><strong><?php echo "Taxa de entrega"; ?> (<?php echo Config::CURRENCY_SYMBOL; ?>)</strong></td>
